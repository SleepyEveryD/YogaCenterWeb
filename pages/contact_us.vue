  ...
  <div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="grid grid-cols-1 gap-12 lg:grid-cols-2">
        ...
        <!-- Contact Info -->
        <div class="bg-white shadow rounded-lg p-6 sm:p-8">
          <h2 class="text-2xl font-bold text-gray-900 mb-6">Our Information</h2>
          ...
          <div class="space-y-6">
            <div class="flex items-start">
              ...
              <div class="ml-4">
                ...
                <p class="mt-1 text-gray-600">123 Yoga Street, Wellness District<br>Milan, Italy 20100</p>
              </div>
            </div>
            ...
            <div class="flex items-start">
              ...
              <div class="ml-4">
                ...
                <p class="mt-1 text-gray-600">info@yogastudio.com</p>
                <p class="mt-1 text-gray-600">support@yogastudio.com</p>
              </div>
            </div>
            ...
            <div class="flex items-start">
              ...
              <div class="ml-4">
                ...
                <p class="mt-1 text-gray-600">+39 02 123 4567</p>
